<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="AddTechnologyRequirement.ascx.cs" Inherits="OnlineLearningSystem.AddTechnologyRequirement" %>
<div class="row">
    <div class="col-sm-4">
        <div>
           ...
           <asp:CheckBox ID="CheckBoxActive" runat="server" Checked="true" />
                &nbsp;
            <asp:Button ID="btnAddTechnologyRequirement" runat="server" CssClass="btn btn-custom btn-sm pull-right" Text="Add Technology" OnClick="btnAddTechnologyRequirement_Click" />
            </div>
        ...
        <br />
        <div>
            <h6>Technology Requirement List</h6>
            <hr />
    ...
    <div class="col-sm-8">
        <div class="margin-left-30">
            <div>
                <h6>Course Technology Requirement</h6>
                <hr />
                <div class="row">
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        <asp:Label CssClass="sp-label" ID="Label3" runat="server" Text="Select Technology: "></asp:Label>
                        <asp:DropDownList CssClass="tex-box form-control" ID="DropDownListTechnologyRequirement" runat="server" AutoPostBack="True"></asp:DropDownList>
                ...
                <div class="margin-top-15">
                    <div class="row">
                        <div class="col-md-4">
                            ...
                            &nbsp;
                           <asp:CheckBox ID="CheckBoxCourseTechnologyActive" runat="server" Checked="true" />
                        </div>
                        <div class="col-md text-right">
                            ...
                            <asp:Button ID="addCourseTechnologyRequirement" runat="server" CssClass="btn btn-custom btn-sm" Text="Add Course Technology" OnClick="addCourseTechnologyRequirement_Click" />
                        </div>
                    </div>
                </div>
                <asp:Label ID="lblMessageCourseTechnology" CssClass="font-size-15" runat="server" ForeColor="Green"></asp:Label>
                 <asp:Label ID="lblErrorMessageCourseTechnology" CssClass="font-size-15" runat="server" ForeColor="Red"></asp:Label>
            </div>
            <br />
            <div>
                <h6>Course Technology Requirement List</h6>
                <hr />
                <div class="font-size-13">
                    <asp:GridView CssClass="table table-bordered grid-table" ID="GridView2" runat="server" AutoGenerateColumns="False" DataKeyNames="TechnologyRequirementId" OnRowCancelingEdit="GridView2_RowCancelingEdit" OnRowEditing="GridView2_RowEditing" OnRowUpdating="GridView2_RowUpdating" OnRowDataBound="GridView2_RowDataBound" OnRowDeleting="GridView2_RowDeleting">
                        <Columns>
                            <asp:BoundField DataField="TechnologyRequirementId" HeaderText="TechnologyRequirementId" ReadOnly="True" Visible="False" />
