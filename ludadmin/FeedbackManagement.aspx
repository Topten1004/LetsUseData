<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FeedbackManagement.aspx.cs" Inherits="OnlineLearningSystem.FeedbackManagement" %>
            ...
            <div class="add-course-area" style="margin: 0 60px;">
                <div class="container-fluid">
                    ...
                    <div class="row">
                            ...
                            <div class="course-list">
                                ...
                                <hr />
                                       <div class="row margin-bottom-10">
                                        ...
                                        <asp:Label ID="Label5" CssClass="font-size-15 margin-right-15" runat="server" Text="Pending"></asp:Label>

                                        <asp:RadioButton ID="RadioButtonDone" runat="server" GroupName="searchType" AutoPostBack="True" OnCheckedChanged="RadioButtonDone_CheckedChanged"/>
                                        <asp:Label ID="Label3" CssClass="font-size-15 margin-right-15" runat="server" Text="Done"></asp:Label>

                                        <asp:RadioButton ID="RadioButtonAll" runat="server" GroupName="searchType" AutoPostBack="True" OnCheckedChanged="RadioButtonAll_CheckedChanged"/>
                                        <asp:Label ID="Label7" CssClass="font-size-15" runat="server" Text="All"></asp:Label>
                                    </div>
                                               <div class="col-md-6 text-right">
                                        <asp:Button ID="ShowAllList" runat="server" CssClass="btn btn-sm btn-custom-light" Text="Clear" OnClick="ShowAllList_Click" />
                                    </div>
                                    </div>
                                <div class="wraper-area margin-bottom-10">
                                            ...
                                            <div class="row">
                                                <div class="col-md-3">
                                                    <asp:Label CssClass="sp-label" ID="Label1" runat="server" Text="Course Instance"></asp:Label>
                                                </div>
                                                <div class="col-md">
                                                    <asp:DropDownList CssClass="tex-box form-control" ID="DropDownListCourseInstanceFilter" runat="server" AutoPostBack="True"></asp:DropDownList>
                                                </div>
                                            </div>
                                        </div>
                             <%--   <div class="row margin-bottom-10">
                        ...
                        <%--        <div class="row margin-bottom-10">
                                    <div class="col-md-3">
                                        <asp:Label CssClass="sp-label" ID="Label6" runat="server" Text="Status"></asp:Label>
                                    </div>
                                    <div class="col-md">
                                        <asp:DropDownList CssClass="tex-box form-control" ID="DropDownListStatus" runat="server" AutoPostBack="True" OnSelectedIndexChanged="DropDownListPriority_SelectedIndexChanged"></asp:DropDownList>
...
<ItemStyle HorizontalAlign="Center"></ItemStyle>
                                            ...
                                            <asp:BoundField DataField="Text" HeaderText="Text" ReadOnly="True" ItemStyle-CssClass="width-200">
<ItemStyle CssClass="width-200"></ItemStyle>
                                            </asp:BoundField>
                                            <asp:BoundField DataField="Status" HeaderText="Status" />
                                            <asp:BoundField DataField="Comment" HeaderText="Comment" />
                                            <asp:ButtonField Text="Show Detail" CommandName="ShowDetail" HeaderText="Action" Visible="False" />
                                        </Columns>
                                    </asp:GridView>
                                </div>
                            </div>
                            ...
                            <div class="margin-left-30">
                                ...
                                <asp:Panel ID="TicketDetailArea" runat="server" Visible="false">
                                    <div class="margin-b-1">
                                        <div class="row">
                                            <div class="col-md-8">
                                                <asp:Label CssClass="sp-label" ID="lblFeedbackId" runat="server" Text="" Visible="false"></asp:Label>
                                    ...
                                    <div class="message-area custome-overflow wraper-area margin-top-10" style="max-height: 280px; height: auto">
                                        <asp:Panel ID="pnlFeedbackDetail" runat="server">
                                        </asp:Panel>
                                    </div>
