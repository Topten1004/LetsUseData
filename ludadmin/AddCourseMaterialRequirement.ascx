<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="AddCourseMaterialRequirement.ascx.cs" Inherits="OnlineLearningSystem.AddCourseMaterialRequirement" %>
<div class="row">
    <div class="col-sm-4">
        <div>
            <h6>Add Material Requirement</h6>
            <hr />
           ...
           <asp:CheckBox ID="CheckBoxActive" runat="server" Checked="true" />
                &nbsp;
            <asp:Button ID="btnAddCourseMaterialRequirement" runat="server" CssClass="btn btn-custom btn-sm pull-right" Text="Add Material" OnClick="btnAddCourseMaterialRequirement_Click" />
            </div>
        ...
        <br />
        <div>
            <h6>Material Requirement List</h6>
            <hr />
    ...
    <div class="col-sm-8">
        <div class="margin-left-30">
            <div>
                <h6>Course Material Requirement Mapping</h6>
                <hr />
                <div class="row">
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        <asp:Label CssClass="sp-label" ID="Label3" runat="server" Text="Select Course Material Requirement: "></asp:Label>
                        <asp:DropDownList CssClass="tex-box form-control" ID="DropDownListCourseMaterialRequirement" runat="server" AutoPostBack="True"></asp:DropDownList>
                    </div>
                </div>
                <div class="margin-top-15">
                    ...
                    &nbsp;
                    <asp:CheckBox ID="CheckBoxCourseMaterialRequirementMapping" runat="server" Checked="true" />
                    </div>
                        <div class="col-md text-right">
                           ...
                           <asp:Button ID="addCourseMaterialRequirementMapping" runat="server" CssClass="btn btn-custom btn-sm" Text="Add Material in Course" OnClick="addCourseMaterialRequirementMapping_Click" />
                        </div>
                    </div>
                </div>
                <asp:Label ID="lblMessageCourseMaterialRequirementMapping" CssClass="font-size-15" runat="server" ForeColor="Green"></asp:Label>
                 <asp:Label ID="lblErrorMessageCourseMaterialRequirementMapping" CssClass="font-size-15" runat="server" ForeColor="Red"></asp:Label>
            </div>
            <br />
            <div>
                <h6>Course Material Requirement Mapping</h6>
                ...
                <div class="font-size-13">
                    <asp:GridView CssClass="table table-bordered grid-table" ID="GridView2" runat="server" AutoGenerateColumns="False" DataKeyNames="CourseMaterialRequirementId" OnRowCancelingEdit="GridView2_RowCancelingEdit" OnRowEditing="GridView2_RowEditing" OnRowUpdating="GridView2_RowUpdating" OnRowDataBound="GridView2_RowDataBound" OnRowDeleting="GridView2_RowDeleting">
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Course Material">
                                <ItemTemplate>
                                    <asp:Label ID="Label1" runat="server" Text='<%# Bind("Description") %>'></asp:Label>
                                </ItemTemplate>
