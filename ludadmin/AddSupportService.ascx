<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="AddSupportService.ascx.cs" Inherits="OnlineLearningSystem.AddSupportService" %>
<div class="row">
    <div class="col-sm-4">
        <div>
            <h6>Add Support Services</h6>
            <hr />
           ...
           <asp:CheckBox ID="CheckBoxActive" runat="server" Checked="true" />
                &nbsp;
                <asp:Button ID="btnAddSupportService" CssClass="btn btn-custom btn-sm pull-right"  runat="server" Text="Add" OnClick="btnAddSupportService_Click" />
            </div>
    ...
    <div class="col-sm-8">
        <div class="margin-left-30">
            <h6>Support Services List</h6>
            <hr />
            <div class="custome-overflow">
                <asp:GridView CssClass="table table-bordered grid-table" ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="SupportServicesId" OnRowCancelingEdit="OnRowCancelingEdit" OnRowEditing="OnRowEditing" OnRowUpdating="OnRowUpdating" OnRowDataBound="OnRowDataBound" OnRowDeleting="OnRowDeleting">
                    <Columns>
                        <asp:BoundField ItemStyle-HorizontalAlign="Center" DataField="SupportServicesId" HeaderText="ID" ReadOnly="True" />
