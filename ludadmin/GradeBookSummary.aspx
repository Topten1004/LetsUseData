<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GradeBookSummary.aspx.cs" Inherits="OnlineLearningSystem.GradeBookSummary" %>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="margin-top-10">
                                <asp:Panel ID="pnlStudentGradeDetails" runat="server">
                                </asp:Panel>
                            </div>
                        </div>
                    </div>
